...
# Display hints owned by this script rather than the preset system — always
# present on work rows, whichever preset is chosen.
...
def _parse_config(config):
    ...
    return title, file_prefix, collection_ark, preset, defaults, page_prefix, layer_prefix, layer_type, file_extensions, page_vol_defaults, ezid_user, ezid_password, ark_shoulder
...
def run(scan_path, base_path, config):
    ...
    """
    title, file_prefix, collection_ark, preset, defaults, page_prefix, layer_prefix, layer_type, file_extensions, page_vol_defaults, ezid_user, ezid_password, ark_shoulder = _parse_config(config)
    ...
    works, works_csv = _process_level1(scan_path, file_prefix, collection_ark, preset, defaults, page_vol_defaults, ezid_user, ezid_password, ark_shoulder)
